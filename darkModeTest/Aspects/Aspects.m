...
+ (id<AspectToken>)aspect_hookStaticSelector:(SEL)selector
                                 withOptions:(AspectOptions)options
                                  usingBlock:(id)block
                                       error:(NSError **)error{
    return aspect_add(objc_getMetaClass(NSStringFromClass(self.class).UTF8String), selector, options, block, error);
} ;
